...
public class ColorsActivity extends AppCompatActivity implements AudioManager.OnAudioFocusChangeListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        words.add(new Word(getResources().getString(R.string.color_yellow), "yellow", R.drawable.color_mustard_yellow, R.raw.color_yellow));
        words.add(new Word(getResources().getString(R.string.color_red), "red", R.drawable.color_red, R.raw.color_red));
        words.add(new Word(getResources().getString(R.string.color_pink), "pink", R.drawable.color_pink, R.raw.color_pink));
        words.add(new Word(getResources().getString(R.string.color_green), "green", R.drawable.color_green, R.raw.color_green));
        words.add(new Word(getResources().getString(R.string.color_blue), "blue", R.drawable.color_blue, R.raw.color_blue));
        words.add(new Word(getResources().getString(R.string.color_brown), "brown", R.drawable.color_brown, R.raw.color_brown));
        words.add(new Word(getResources().getString(R.string.color_grey), "gray", R.drawable.color_gray, R.raw.color_grey));
