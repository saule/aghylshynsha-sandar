...
public class WordAdapter extends ArrayAdapter<Word> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        RelativeLayout textContainer = listItemView.findViewById(R.id.textContainer);
        ...
        TextView eng_number_TextView = listItemView.findViewById(R.id.english_number_textview);
        ...
        TextView numberTextView =  listItemView.findViewById(R.id.qazaq_number_textview);
        ...
        ImageView iconView = listItemView.findViewById(R.id.word_imageview);
